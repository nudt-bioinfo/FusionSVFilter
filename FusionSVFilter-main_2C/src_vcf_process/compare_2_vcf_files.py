...
if __name__=='__main__':
    data_dir="../data/vcf_5_tools/CLR_minimap2/"
    vcf1_name="cutesv-CLR-minimap2.sorted.vcf"
    vcf2_name="sniffles-HiFi-minimap2.sorted.vcf"
    output_file="output_5_tools_4_difference/Sniffles_difference_cmp_to_cuteSV.vcf"
