...
#     root_dir + "models-self/" + config['model'] + ".ckpt", path=root_dir + "data/", config=config)

model_name1="ResNet50_2C_97"
model = IDENet.load_from_checkpoint(
    root_dir + "models-self/" + model_name1 + ".ckpt", path=root_dir + "data/", config=config)
