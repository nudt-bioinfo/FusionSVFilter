...
#         return DataLoader(dataset=self.train_dataset, batch_size=self.batch_size, pin_memory=True,
#                           num_workers=int(cpu_count()), shuffle=True)
#
#     def val_dataloader(self):
#         return DataLoader(dataset=self.test_dataset, batch_size=self.batch_size, pin_memory=True,
...
#             filter(lambda p: p.requires_grad, self.parameters()), lr=self.lr, betas=(self.beta1, self.beta2),
